...
const styles = StyleSheet.create({
  ...
  separator: {
    marginVertical: 10, // Margin Top and Bottom (MT & MB)
    borderBottomWidth: 1,
    borderBottomColor: "#eee", // Nopenena tharam light color ekak
    borderStyle: "dashed",
  },
  developerInfo: {
    marginTop: 4,
    ...
    <Document title={`stylish-lab-${sale.invoiceNo}`}>
      <Page size="A5" style={styles.page}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Bridebox Salon.</Text>
        </View>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.developerInfo}>
            Software Developed By Chamika Gayashan.
          </Text>
          <Text style={styles.developerInfo}>Contact: +94 77 210 1809</Text>
        </View>
      </Page>
    </Document>
  );
