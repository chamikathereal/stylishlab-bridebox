...
public class EmployeeController {
    ...
    @PostMapping
    @Operation(summary = "Create employee", description = "Register a new employee with user account and initial commission")
    ...
    @Operation(summary = "Update employee commission", description = "Closes current commission and creates new one. Old sales remain unchanged.")
    ...
    @Operation(summary = "Get commission history for an employee")
